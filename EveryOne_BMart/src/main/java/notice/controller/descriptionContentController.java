...
import notice.model.DescriptionBean;
...
public class descriptionContentController {
	...
	public String dcontent(@RequestParam(value =  "dnum", required = true) int dnum,
		...
		if(session.getAttribute("loginInfo") == null) {
			session.setAttribute("destination", "redirect:/dcontent.nt?dnum=" + dnum + "&pageNumber=" + pageNumber + "&whatColumn=" + whatColumn + "&keyword=" + keyword);
