					...
					<nav class="nav flex-column">
						...
						<div class="search-form">
							<form action="list.nt" method="get">
								...
								<br> <input type="text" name="keyword" placeholder="검색어를 입력하세요">
								<input type="submit" value="검색">
							</form>
						</div>
						<hr>
						<font class="my-2" color="#186E6A">배민 B마트</font> <a
							class="nav-link text-muted" aria-current="page" href="list.nt?whatColumn=category&keyword=FAQ"> FAQ
						</a> <a class="nav-link text-muted" aria-current="page" href="list.nt?whatColumn=category&keyword=공지사항">
							공지사항 </a>
						<hr>
...
<body>
	<div class="container">
					...
					<c:otherwise>
						...
						<c:forEach var="nt" items="${lists}">
							<tr>
								...
								<td align="left"><a href="#" class="title-link"
									data-nnum="${nt.nnum}" data-pagenumber="${pageInfo.pageNumber}"
									data-whatcolumn="${param.whatColumn}"
		...
		<c:if test="${loginInfo.id == 'admin'}">
			...
			<button class='plus_btn' onclick="location.href='insert.nt?whatColumn=${param.whatColumn }&keyword=${param.keyword}'">추가</button>
		</c:if>
		<!-- <div class="search-form">
			<form action="list.nt" method="get">
				<select name="whatColumn">
