	...
	<div class="card shadow mx-auto my-4 w-75">
		<div class="card-header py-3" style="text-align: right;">
			...
			<button type="submit" class="btn btn-primary btn-sm">
				<i class="fi fi-rr-plus-small"></i> 추가하기
			</button>
		</div>
		<div class="card-body">
			<table class="table table-bordered" id="dataTable">
				...
				<tr>
					...
					<td>
						...
						<form:errors path="pname" cssClass="err"></form:errors>
					</td>
				</tr>
				<tr>
					<th>상품이미지</th>
					<td><input type="file" name="upload" value="${product.pimage}"></td>
				</tr>
				<tr>
					<th>가격</th>
				...
				<tr>
					...
					<td>
						...
						<form:errors path="origin" cssClass="err"></form:errors>
					</td>
				</tr>
				<tr>
					<th>소비기한</th>
					<td><input type="text" name="expritydate" value="${product.expritydate}"></td>
				</tr>
				<tr>
					<th>중량/용량</th>
					<td><input type="text" name="capacity" value="${product.capacity}"></td>
				</tr>
				<tr>
				    <th>설명</th>
				    <td>
				        <textarea name="pcontent" id="content">${product.pcontent}</textarea>
