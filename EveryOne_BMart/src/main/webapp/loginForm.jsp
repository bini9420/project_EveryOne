						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="p-5">
									...
									<form class="user" method="post" action="loginForm.mb">
										<div class="form-group">
											<input type="text" class="form-control form-control-user"
												id="exampleInputEmail" name="id"
                                       ...
                                       class="btn btn-google btn-user btn-block">
                                         ...
                                         -->
											...
											<script type='text/javascript'>
												...
												Kakao
														.init('c45881ccb1b269e77166b83da79dc653');
												// 카카오 로그인 버튼을 생성합니다.
												Kakao.Auth
														.createLoginButton({
											...
											<a href=""
												class="btn btn-google btn-user btn-block"
												style="background-color: yellow; color: black;">  Login with Kakao
											</a> <a href="index.html"
